    ...
    <div class="relative overflow-x-auto">
        <div class="container mx-auto px-5">
            <div class=" mt-10 mb-5 flex flex-col md:flex-row justify-between items-center md:space-y-0 ">
                ...
                <a href="{{ route('meeting.create') }}" class="bg-teal-500 text-white px-4 py-2 rounded-lg"><i
                                ...
                                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    ...
                                    <tbody>
                                        ...
                                        <tr
                                            ...
                                            <td class="px-6 py-4 border border-gray-300 dark:border-gray-700">
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="font-normal text-gray-500 mt-5">
                                                        <a target="__blank" class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900"
                                            ...
                                            <td class="px-6 py-4 border border-gray-300 dark:border-gray-700">
                                                <a rel="focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:focus:ring-yellow-900">
                                                    {{ $meeting->status ?? '' }}
                                                </a>
                                            </td>
                                            {{-- <td class="px-6 py-4 border border-gray-300 dark:border-gray-700">
