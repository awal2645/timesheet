                                                    ...
                                                    <td class="px-6 py-4 border border-gray-300 dark:border-gray-700">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <div class="font-normal text-gray-500 mt-5">
                                                                <a target="__blank"
                                                                    class="text-white bg-purple-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mb-2 dark:bg-purple-500 dark:hover:bg-purple-700 dark:focus:ring-blue-900"
