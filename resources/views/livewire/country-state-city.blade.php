<div>
    <div class="{{ $row ? 'row':'select-wrapper mx-0 w-100 d-flex flex-column' }}">
        <div class="{{ $row ? 'col-lg-4':'px-0 w-100' }}">
            <select id="" name="country" wire:model="selectedCountryId" class="select21 location country max-w-100">
        ...
        <div class="{{ $row ? 'col-lg-4':'px-0 w-100' }}">
            <select name="state" wire:model="selectedStateId" class="select21 location state max-w-100">
        ...
        <div class="{{ $row ? 'col-lg-4':'px-0 w-100' }}">
            <select name="district" wire:model="selectedCityId" class="select21 location city max-w-100">
