                ...
                <div class="w-full ">
                    <div class="dashboard-right pl-0 ">
                        <div class="invoices-table ">
                            <h2 class="text-2xl font-bold mb-4 text-text-light dark:text-text-dark">{{ __('Latest Project') }}</h2>
                            <div class="overflow-hidden">
                                <div class="rounded-lg border border-black/10 dark:border-white/10 shadow-lg bg-body-light backdrop-blur dark:bg-body-dark px-5 pb-2.5 pt-6 shadow-default sm:px-7.5 xl:pb-1">
                                    <div class="max-w-full">
                                        <table class="w-full table-auto">
                                            <thead class="bg-primary-300 text-text-light dark:text-text-dark">
                                                <tr class="rounded-2xl text-left ">
                                                    <th class="min-w-[220px] px-4 py-4 font-medium">{{ __('Project Name') }}</th>
                                                    <th class="min-w-[150px] px-4 py-4 font-medium">{{ __('Client Name') }}</th>
                                                    <th class="min-w-[120px] px-4 py-4 font-medium">{{ __('Billing Type') }}</th>
                                            ...
                                            <tbody>
                                                ...
                                                @endphp
                                                        <tr class="hover:bg-gray-100 hover:dark:bg-gray-800 transition duration-200">
                                                            <td class="border-b border-[#eee] dark:border-slate-700 px-4 py-3">{{ $project->project_name ?? '' }}</td>
                                                            <td class="border-b border-[#eee] dark:border-slate-700 px-4 py-3">{{ $project->client->client_name ?? '' }}</td>
                                                            <td class="border-b border-[#eee] dark:border-slate-700 px-4 py-3">{{ $project->payment_type ?? '' }}</td>
                                                            <td class="border-b border-[#eee] dark:border-slate-700 px-4 py-3">{{ number_format($totalHours, 2) ?? '' }}</td>
                                                            <td class="border-b border-[#eee] dark:border-slate-700 px-4 py-3">${{ number_format($totalCost, 2) ?? '' }}</td>
                                                            <td class="border-b border-[#eee] dark:border-slate-700 px-4 py-3">{{ $project->total_paid ?? '' }}</td>
