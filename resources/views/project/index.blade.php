@section('title') {{'List Project'}} @endsection
<x-app-layout>
                    ...
                    <div class="mb-5">
                        ...
                        <div class="flex">
                            <input type="text" id="search" name="search" value="{{ request('search') }}"
                                ...
                                placeholder="Search" />
                            <button class="bg-blue-500 text-white px-4 py-2 rounded-lg ml-2 ml-2">Search</button>
                        </div>
                    </div>
                </form>
                <a href="{{ route('project.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg"><i
                                            ...
                                            <th scope="row"
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="font-normal text-gray-500">
                                                        {{ $project->employer->employer_name ?? '' }}
                                                    </div>
                                                </div>
                                            </th>
