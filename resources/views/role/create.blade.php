<x-app-layout>
    <div class="max-w-lg mx-auto mt-6 p-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
        ...
        <form method="POST" action="{{ route('role.store') }}" class="max-w-lg mx-auto space-y-6">
            ...
            <!-- Submit Button -->
            <button type="submit"
                class="block w-full text-lg font-semibold text-white bg-teal-500 hover:bg-teal-500 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 py-3 rounded-lg shadow-md transition-colors duration-300">{{ __('Submit') }}</button>
        </form>
    </div>
</x-app-layout>
