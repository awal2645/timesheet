...
<x-app-layout>
    <div class="relative overflow-x-auto">
        <div class="container mx-auto px-5">
            <div class=" mt-10 mb-5 flex flex-col md:flex-row justify-between items-center md:space-y-0 ">
                ...
                <a href="{{ route('role.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg"><i
                                    ...
                                    <tbody>
                                        ...
                                        <tr
                                            ...
                                            <th scope="row"
                                                ...
                                                <div class="">
                                                    <div class="text-base font-semibold capitalize">{{ $role->name ?? ''
                                                        }}</div>
                                            ...
                                            <td class="px-6 py-4 border border-gray-300 dark:border-gray-700">
                                                ...
                                                <span
                                                    class="inline-flex items-center justify-center px-2 py-1 mr-2 mb-2 text-xs font-bold leading-none text-white bg-gray-500 rounded-full">{{
                                        ...
                                        <tr
                                            ...
                                            <th scope="row"
                                                class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                                                <div class="">
                                                    <div class="text-base font-semibold text-sm capitalize">{{ $role->name ?? ''
                                                        }}</div>
    ...
    <script>
        function showConfirmation(id) {
            Swal.fire({
                title: 'Want to delete this Role',
