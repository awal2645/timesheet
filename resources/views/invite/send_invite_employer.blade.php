    ...
    @else
        <div class="max-w-lg mx-auto mt-6 p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
            ...
            <form method="POST" action="{{ route('invite.send.employee') }}" class="max-w-md mx-auto">
                ...
                <button type="submit"
                    class="text-white bg-teal-500 dark:bg-teal-900 hover:bg-[#1da8f7] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-teal-500 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
            </form>
        </div>
    @endif
</x-app-layout>
