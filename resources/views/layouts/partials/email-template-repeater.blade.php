            ...
            <div class="grid grid-cols-1 gap-6">
                <div class="col-span-1">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" id="name" class="mt-1 block w-full border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm dark:bg-gray-700 dark:text-gray-300" value="{{ $name ?? '' }}" @if (empty($is_new)) disabled @endif>
                    ...
                    @if (!empty($is_new))
                        <div class="mb-4">
                            ...
                            <input type="text" name="type" id="type" class="mt-1 block w-full border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm dark:bg-gray-700 dark:text-gray-300" value="{{ $type ?? '' }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="subject" id="subject" class="mt-1 block w-full border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm dark:bg-gray-700 dark:text-gray-300" value="{{ $subject ?? '' }}">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="message" id="message" class="mt-1 block w-full border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm dark:bg-gray-700 dark:text-gray-300 classic-editor" cols="30" rows="10">{{ $message ?? '' }}</textarea>
                    ...
                    @if (!empty($flags["search"]))
                        <small class="block text-sm text-gray-500 dark:text-gray-400">
                            ...
                            @foreach ($flags["search"] as $flag)
                                <code class="bg-gray-100 dark:bg-gray-600 dark:text-gray-100 p-1 rounded">{{ $flag }}</code>@if (!$loop->last),@else.@endif
                            @endforeach
                        </small>
                    @endif
                </div>
