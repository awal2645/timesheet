...
<x-app-layout>
    <div class="py-12 px-8">
        ...
        <form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data"
            ...
            <button type="submit"
                class="mt-6 text-white bg-purple-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-purple-500 dark:hover:bg-purple-700 dark:focus:ring-blue-800">
                {{ __('Save Settings') }}
            </button>
        </form>
    </div>
