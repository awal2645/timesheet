...
<x-app-layout>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="bg-white dark:bg-slate-800 shadow-2xl rounded-3xl overflow-hidden border border-gray-200 dark:border-gray-700">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                            {{ __('Complete all required fields to register a new client. Fields marked with * are mandatory.') }}
                        </p>
                    </div>
            ...
            <!-- Form Content -->
            <div class="p-8">
                <form method="POST" action="{{ route('client.store') }}" class="space-y-8" id="clientForm">
            @csrf
                    ...
                    <div class="space-y-6">
                        <div class="border-b border-gray-200 dark:border-gray-600 pb-4">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">{{ __('Essential client details and contact information') }}</p>
                        </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative group">
                                    <select name="employer_id" id="employer_id" required
                                            class="w-full px-4 py-4 border-2 border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-slate-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200 appearance-none hover:border-gray-400 dark:hover:border-gray-500 group-hover:shadow-md">
            ...
            <!-- Client Name -->
                            <div class="space-y-2">
                                <label for="client_name" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">
                                    <span class="flex items-center">
            ...
            <!-- Client Email -->
                            <div class="space-y-2">
                                <label for="client_email" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">
                                    <span class="flex items-center">
            ...
            <!-- Client Phone -->
                            <div class="space-y-2">
                                <label for="client_phone" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">
                                    <span class="flex items-center">
            ...
            <!-- Contact Name -->
                            <div class="space-y-2">
                                <label for="contact_name" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">
                                    <span class="flex items-center">
                ...
                @enderror
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-sm text-emerald-700 dark:text-emerald-400">
                                    {{ __('Make sure all client information is accurate as this will be used for project assignments and communications. The contact person will be the primary point of contact for all project-related matters.') }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-between pt-8 border-t border-gray-200 dark:border-gray-600 space-y-4 sm:space-y-0">
                        ...
                        <button type="submit" id="submitBtn"
                            ...
                            <span class="submit-text">{{ __('Create Client') }}</span>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function() {
                ...
                submitText.textContent = '{{ __("Creating Client...") }}';
                loadingSpinner.classList.remove('hidden');
                submitBtn.classList.add('opacity-75');
            });

            // Real-time form validation feedback
            const requiredFields = ['client_name', 'client_email', 'client_phone', 'contact_name'];
            const allFields = ['employer_id', 'client_name', 'client_email', 'client_phone', 'contact_name'];
