...
<x-app-layout>
    <div
        class="flex justify-between m-8 bg-white/10 px-8 py-4 rounded-xl border border-black/10 dark:bg-black/10 backdrop-blur">
        <h2 class="text-xl font-medium">Create Client</h2>
        <a href="" class="btn bg-teal-500 dark:bg-teal-900 text-white">Go to Client List</a>
    </div>
    <div
        class="max-w-lg mx-auto mt-6 p-6 bg-white/10 backdrop-blur border border-gray-900/10 dark:bg-gray-800/10 dark:border-white/10 rounded-lg shadow-md">
        ...
        <form method="POST" action="{{ route('client.store') }}" class="max-w-md mx-auto">
            ...
            <button type="submit"
                class="text-white bg-teal-500 dark:bg-teal-900 hover:bg-teal-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Submit</button>
