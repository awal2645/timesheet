                                ...
                                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    ...
                                    <tbody>
                                        ...
                                        <tr
                                            ...
                                            <th scope="row"
                                                class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white border-l border-gray-300 dark:border-gray-700">

                                                <div class="">
                                                    <div class="text-base font-semibold">{{ $client->client_name }}
                                                    </div>
                                                    <div class="font-normal text-gray-500">{{ $client->client_email }}
                                                    </div>
                                                </div>
                                            </th>
                                                ...
                                                <div class="flex items-center space-x-2">
                                                    ...
                                                    <form id="statusForm{{ $client->id }}"
                                                        ...
                                                        <select name="status" id="status"
                                                            ...
                                                            <option class="dark:bg-slate-800" value="1" {{ $client->
                                                                status === 1 ? 'selected' : '' }}>Active</option>
                                                            <option class="dark:bg-slate-800" value="0" {{ $client->
                                            ...
                                            <td class="px-6 py-4 border border-gray-300 dark:border-gray-700">
                                                <div class="flex space-x-2">
                                                    ...
                                                    <a onclick="showConfirmation({{ $client->id }})"
