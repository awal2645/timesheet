        ...
        <div class="m-6 card">
            ...
            <div class="">
                ...
                <div class="mb-4 flex justify-between">
                    ...
                    <button id="previousWeek"
                        class="text-white bg-primary-300 hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mb-2 dark:bg-primary-300 dark:hover:bg-primary-300 dark:focus:ring-primary-900">Previous
                        Week</button>
                    <button id="nextWeek"
                        class="text-white bg-primary-300 hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mb-2 dark:bg-primary-300 dark:hover:bg-primary-300 dark:focus:ring-primary-900">Next
                        Week</button>
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-md shadow-md dark:bg-gray-800 ">
                ...
                <button @if ($timeReport) disabled @endif type="button" id="saveButton"
                    class="bg-primary-300 ml-3 text-white px-4 py-2 rounded-md hover:bg-primary-600 focus:outline-none focus:ring focus:border-primary-300">
                    {{ __('Save') }}
                </button>
