...
<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <!-- Welcome banner -->
        <div class="relative bg-blue-500 dark:bg-indigo-500 p-4 sm:p-6 rounded-sm overflow-hidden mb-8">
            ...
            <div class="relative">
                ...
                <p class="dark:text-indigo-200">Employer Email: {{auth('web')->user()->employee->employer->user->email}}
                </p>
                @endif
            </div>
                                ...
                                <table class="min-w-full table-auto text-sm">
                                    <thead class="bg-white shadow-lg rounded-sm border border-slate-200 dark:border-gray-800 dark:text-gray-100 dark:bg-gray-800">
                                        <tr class="text-center">
                                            <th class="p-3 border border-gray-300 dark:border-gray-700">Invoice Number</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center  mt-5 pt-5">
                                            ...
                                            <td class="py-3 border border-gray-300 dark:border-gray-700">
                                                ...
                                                @else
                                                <span class="px-2 py-1 text-sm bg-blue-500 text-white rounded">{{
                                                    $transaction->plan->label }}</span>
                                                @endif
                                            </td>
                                    ...
                                    <tbody>
                                        ...
                                        <tr
                                            ...
                                            <th scope="row"
                                                ...
                                                <div class="">
                                                    <div class="text-base font-semibold">{{ $timeReport->user->username
                                                        }}</div>
                                                    <div class="font-normal text-gray-500">{{ $timeReport->user->email
                                                        }}</div>
                                                </div>
                                            </th>
                                            ...
                                            <td class="px-6 py-4 border border-gray-300 dark:border-gray-700">
                                                <div class="flex items-center space-x-2">
                                                    ...
                                                    <form id="statusForm{{ $timeReport->id }}"
                                                        ...
                                                        @csrf
                                                        @if (auth('web')->user()->role == 'employee')
                                                        <div class="dark:bg-slate-800" {{ $timeReport->status ===
                                                            'approve' ? '' : 'hidden' }}>Approve</div>
                                                        <div class="dark:bg-slate-800" {{ $timeReport->status ===
                                                            'decline' ? '' : 'hidden' }}>Decline</div>
                                                        <div class="dark:bg-slate-800" {{ $timeReport->status ===
                                                            'pending' ? '' : 'hidden' }}>Pending</div>
                                                        @else
                                                        <select name="status" id="status"
                                                            ...
                                                            <option class="dark:bg-slate-800" value="approve" {{
                                                                $timeReport->status === 'approve' ? 'selected' : ''
                                                                }}>Approve
                                                            </option>
                                                            <option class="dark:bg-slate-800" value="decline" {{
