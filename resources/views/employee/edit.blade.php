    ...
    <div class="m-6 card">
        ...
        <form method="POST" action="{{ route('employee.update', ['id' => $employee->id]) }}"
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                ...
                <!-- Total Leave -->
                <div class="form-field">
                    <input type="number" name="total_leave" id="total_leave" value="{{ $employee->total_leave }}" />
                ...
                <div id="project_details_field" style="display: none;">
                    ...
                    <div class="form-field">
                        <input type="text" name="employee_share" id="employee_share"
                            value="{{ old('employee_share') ?? $employee->employee_share }}" maxlength="3" max="99" />
            ...
            <button type="submit"
                class="text-text-light dark:text-text-dark bg-primary-50 hover:bg-primary-300 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-primary-50 dark:hover:bg-primary-50 dark:focus:ring-primary-800">
                {{ __('Submit') }}</button>
        </form>
    </div>
    <script>
