...
<x-app-layout>
 ...
 dark:text-text-dark  " value="project" {{ 'project'==$employee->payment_type ? 'selected' : '' }}>
            ...
            <button type="submit"
                class="text-text-light dark:text-text-dark bg-primary-50 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-primary-50 dark:hover:bg-primary-50 dark:focus:ring-primary-800">
                {{ __('Submit') }}</button>
        </form>
    </div>
    <script>
