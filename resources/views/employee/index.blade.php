    ...
    <div class="relative overflow-x-auto">
        <div class="container mx-auto px-5">
            <div class=" mt-10 mb-5 flex flex-col md:flex-row justify-between items-center md:space-y-0 ">
                ...
                <a href="{{ route('employee.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg"><i
                                        ...
                                        <tr
                                            ...
                                            <th scope="row"
                                                ...
                                                <img class="w-10 h-10 rounded-full"
                                                    src="{{ asset($employee->user->image) }}" alt="image">
                                                @else
                                                <img class="w-10 h-10 rounded-full"
                                                ...
                                                @endif
                                                <div class="">
                                                    <div class="text-base font-semibold">{{ $employee->employee_name }}
                                                    </div>
                                                    <div class="font-normal text-gray-500">{{ $employee->user->email }}
                                                    </div>
                                                </div>
                                            </th>
                                                ...
                                                <div class="flex items-center space-x-2">
                                                    ...
                                                    <form id="statusForm{{ $employee->id }}"
                                                        ...
                                                        <select name="status" id="status"
                                                            ...
                                                            <option class="dark:bg-slate-800" value="1" {{ $employee->
                                                                status === 1 ? 'selected' : '' }}>Active</option>
                                                            <option class="dark:bg-slate-800" value="0" {{ $employee->
