        ...
        <form method="POST" action="{{ route('employee.store') }}" class="card">
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                ...
                <div id="monthly_salary_field" class="form-field">
                    <input type="number" step="0.01" name="monthly_salary" id="monthly_salary" value="{{ old('monthly_salary') }}" />
                ...
                <div id="project_details_field" style="display: none;">
                    <!-- Employee Share -->
                    <div class="form-field">
                        <input type="number" name="employee_share" id="employee_share" value="{{ old('employee_share') }}"
                    ...
                    <!-- Billing Rate -->
                    <div class="form-field">
                        <input type="number" step="0.01" name="billing_rate" id="billing_rate" value="{{ old('billing_rate') }}" />
