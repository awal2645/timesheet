            ...
            <div
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
                    ...
                    <div class="lg:sticky lg:top-8">
                        <div class="space-y-4">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-white/90">Live Preview</h3>
                            <div id="preview" class="p-6 rounded-xl border shadow-sm transition-all duration-200">
                                <h4 class="text-2xl font-bold mb-4">Primary text</h4>
                                <p class="mb-6">This is secondary text. Try changing the colors and fonts to see it
                                    update in real-time!</p>
                                <div class="flex flex-wrap gap-4">
                                    <button
                                        class="preview-button bg-primary-500 text-white px-4 py-2 rounded-lg transition-all duration-200 transform hover:-translate-y-0.5">
                                        Primary button
                                    </button>
                                    <button
                                        class="preview-button bg-secondary-500 text-white px-4 py-2 rounded-lg transition-all duration-200 transform hover:-translate-y-0.5">
                                        Secondary button
                                    </button>
                                </div>
                            </div>
