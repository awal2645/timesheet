...
<x-app-layout>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="bg-white dark:bg-slate-800 shadow-2xl rounded-3xl overflow-hidden border border-gray-200 dark:border-gray-700">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                            {{ __('Complete all required fields to register a new employer. Fields marked with * are mandatory.') }}
                        </p>
                    </div>
            ...
            <!-- Form Content -->
            <div class="p-8">
                <form method="POST" action="{{ route('employer.store') }}" class="space-y-8" id="employerForm">
            @csrf
            ...
            <!-- Address Fields -->
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-sm text-teal-700 dark:text-teal-400">
                                    {{ __('Make sure all information is accurate as this will be used for official records and communications. The employer name and email address are required fields and cannot be changed easily after creation.') }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-between pt-8 border-t border-gray-200 dark:border-gray-600 space-y-4 sm:space-y-0">
                        ...
                        <button type="submit" id="submitBtn"
                            ...
                            <span class="submit-text">{{ __('Create Employer') }}</span>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function() {
                ...
                submitText.textContent = '{{ __("Creating Employer...") }}';
