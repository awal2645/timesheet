    ...
    <div class="relative overflow-x-auto">
        <div class="container mx-auto px-5">
            <div class=" mt-10 mb-5 flex flex-col md:flex-row justify-between items-center md:space-y-0 ">
                ...
                <a href="{{ route('employer.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg"><i
                                    ...
                                    <tbody>
                                        ...
                                        <tr
                                            ...
                                            <th scope="row"
                                                ...
                                                @endif
                                                <div class="">
                                                    <div class="text-base font-semibold">{{ $employer->employer_name }}
                                                    </div>
                                                    <div class="font-normal text-gray-500">{{ $employer->user->email }}
                                                    </div>
                                                </div>
                                            </th>
                                                ...
                                                <div class="flex items-center space-x-2">
                                                    ...
                                                    <form id="statusForm{{ $employer->id }}"
                                                        ...
                                                        <select name="status" id="status"
                                                            ...
                                                            <option class="dark:bg-slate-800" value="1" {{ $employer->
                                                                status ===
                                                                1 ? 'selected' : '' }}>Active</option>
                                                            <option class="dark:bg-slate-800" value="0" {{ $employer->
                                                                status ===
                                                                0 ? 'selected' : '' }}>Inactive</option>
                                                        </select>
                                                    </form>
                                            ...
                                            <td class="px-6 py-4 flex  space-x-2">
                                                ...
                                                <a onclick="showConfirmation({{ $employer->id }})"
