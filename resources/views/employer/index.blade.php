    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    <div class="mb-6 lg:mb-0">
                        <h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-3 tracking-tight">
                            {{ __('Employer Management') }}
                        </h1>
                        <p class="text-lg text-gray-600 dark:text-gray-400 max-w-2xl">
                            {{ __('Comprehensive dashboard to manage, track, and analyze all your employers and their activities') }}
                        </p>
                    </div>
                    ...
                    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-200 dark:border-gray-700 text-center">
                            <div class="text-2xl font-bold text-green-600 dark:text-green-400 mb-1">
                                {{ $employers->where('status', 1)->count() }}
                            </div>
                            <div class="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide">
                                {{ __('Active') }}
                            </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-200 dark:border-gray-700 text-center">
                            <div class="text-2xl font-bold text-red-600 dark:text-red-400 mb-1">
                                {{ $employers->where('status', 0)->count() }}
                            </div>
                            <div class="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide">
                                {{ __('Inactive') }}
                            </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-200 dark:border-gray-700 text-center">
                            <div class="text-2xl font-bold text-purple-600 dark:text-purple-400 mb-1">
                                {{ $employers->sum(function($emp) { return $emp->employee->count(); }) }}
                            </div>
                            <div class="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide">
                                {{ __('Total Employees') }}
                            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 mb-8">
                ...
                <form action="{{ route('employer.index') }}" method="GET" class="p-6">
                    <!-- Main Search Row -->
                        ...
                        <div class="lg:col-span-6">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" 
                                       ...
                                       placeholder="{{ __('Search by employer name or email...') }}" />
                            </div>
                        </div>
                    ...
                    <div id="advancedFilters" class="hidden border-t border-gray-200 dark:border-gray-700 pt-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            <div>
                                <label for="min_employees" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    {{ __('Min Employees') }}
                                </label>
                                <input type="number" 
                                       id="min_employees" 
                                       name="min_employees" 
                                       value="{{ request('min_employees') }}"
                                       placeholder="0"
                            ...
                            <div>
                                <label for="max_employees" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    {{ __('Max Employees') }}
                                </label>
                                <input type="number" 
                                       id="max_employees" 
                                       name="max_employees" 
                                       value="{{ request('max_employees') }}"
                                       placeholder="1000"
                                       class="block w-full py-2.5 px-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200" />
                            </div>
                            ...
                            <!-- Has Website Filter -->
                            <div>
                                <label for="has_website" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    {{ __('Website') }}
                                </label>
                                <select name="has_website" id="has_website" class="block w-full py-2.5 px-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200">
                                    <option value="">{{ __('All') }}</option>
                                    <option value="1" {{ request('has_website') == '1' ? 'selected' : '' }}>{{ __('Has Website') }}</option>
                                    <option value="0" {{ request('has_website') == '0' ? 'selected' : '' }}>{{ __('No Website') }}</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex flex-wrap gap-2">
                                ...
                                <button type="button" class="quick-filter px-3 py-1.5 text-xs bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-full hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors duration-200" data-filter="large">
                                    {{ __('Large (50+ Employees)') }}
                                </button>
                                <button type="button" class="quick-filter px-3 py-1.5 text-xs bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-full hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors duration-200" data-filter="with-website">
                                    {{ __('With Website') }}
                                </button>
                            </div>
                        </div>
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                                            ...
                                            <div class="flex-shrink-0 w-12 h-12 relative">
                                                    ...
                                                    <div class="w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center border-2 border-gray-200 dark:border-gray-600">
                                                        <span class="text-white font-semibold text-lg">
                                                            {{ substr($employer->employer_name, 0, 1) }}
                                                        </span>
                                                    </div>
                                                            @endif
                                                <div class="absolute -bottom-1 -right-1 w-4 h-4 rounded-full {{ $employer->status === 1 ? 'bg-green-500' : 'bg-red-500' }} border-2 border-white dark:border-gray-800"></div>
                                            </div>
                                            <div class="ml-4">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @if($employer->website)
                                               ...
                                               class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 hover:bg-green-200 dark:hover:bg-green-900/50 transition-colors duration-200">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <div class="relative">
                                                <input type="checkbox" 
                                                       id="status-toggle-{{ $employer->id }}"
                                                       class="sr-only"
                                                       {{ $employer->status === 1 ? 'checked' : '' }}
                                                       onchange="toggleStatus({{ $employer->id }}, this.checked)">
                                                <label for="status-toggle-{{ $employer->id }}" 
                                                       class="flex items-center cursor-pointer">
                                                    <div class="relative">
                                                        <!-- Toggle Background -->
                                                        <div class="toggle-bg w-12 h-6 rounded-full shadow-inner transition-colors duration-200 ease-in-out {{ $employer->status === 1 ? 'bg-green-500' : 'bg-gray-300 dark:bg-gray-600' }}"></div>
                                                        <!-- Toggle Circle -->
                                                        <div class="toggle-dot absolute top-0.5 left-0.5 bg-white w-5 h-5 rounded-full shadow transition-transform duration-200 ease-in-out {{ $employer->status === 1 ? 'transform translate-x-6' : '' }}"></div>
                                                    </div>
                                                </label>
                                            </div>
                                            
                                            <!-- Status Badge -->
                                            <span class="status-badge inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium {{ $employer->status === 1 ? 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300' : 'bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300' }}">
                                                <div class="status-dot w-2 h-2 rounded-full mr-1.5 {{ $employer->status === 1 ? 'bg-green-500' : 'bg-red-500' }}"></div>
                                                <span class="status-text">
                                                    {{ $employer->status === 1 ? __('Active') : __('Inactive') }}
                                                </span>
                                            </span>
                                                            </div>
                                        ...
                                        <!-- Hidden form for status update -->
                                              ...
                                              class="hidden">
                                                                @csrf
                                            <input type="hidden" name="status" value="{{ $employer->status }}">
                                                            </form>
                                                    </td>
                                    ...
                                    <td colspan="4" class="px-6 py-16 text-center">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">{{ __('No employers found') }}</h3>
                                            <p class="text-gray-500 dark:text-gray-400 mb-6 max-w-sm">{{ __('You haven\'t added any employers yet. Get started by creating your first employer.') }}</p>
                                            <a href="{{ route('employer.create') }}"
                                               class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors duration-200">
                                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                                                </svg>
                                                {{ __('Create First Employer') }}
                                            </a>
                                        </div>
                                                    </td>
                    ...
                    <div class="px-6 py-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50">
                        <div class="flex items-center justify-between">
                            <div class="text-sm text-gray-700 dark:text-gray-300">
                                {{ __('Showing') }} 
                                <span class="font-medium">{{ $employers->firstItem() }}</span>
                                {{ __('to') }}
                                <span class="font-medium">{{ $employers->lastItem() }}</span>
                                {{ __('of') }}
                                <span class="font-medium">{{ $employers->total() }}</span>
                                {{ __('results') }}
                            </div>
    ...
    <script>
        function showConfirmation(id) {
            Swal.fire({
                ...
                text: "{{ __('You want to delete this employer. This action cannot be undone!') }}",
                icon: 'warning',
        ...
        document.addEventListener('DOMContentLoaded', function() {
                ...
                button.addEventListener('click', function() {
                    ...
                    switch(filter) {
                        ...
                        case 'inactive':
                            ...
                            break;
                        case 'large':
                            params.set('min_employees', '50');
                            break;
                        case 'with-website':
                            params.set('has_website', '1');
                            break;
                    }
            ...
            function updateActiveFilters() {
                ...
                const minEmployees = document.getElementById('min_employees') ? document.getElementById('min_employees').value : '';
                const maxEmployees = document.getElementById('max_employees') ? document.getElementById('max_employees').value : '';
                const hasWebsite = document.getElementById('has_website') ? document.getElementById('has_website').value : '';
                ...
                if (minEmployees) filters.push({ label: `Min Employees: ${minEmployees}`, field: 'min_employees', value: minEmployees });
                if (maxEmployees) filters.push({ label: `Max Employees: ${maxEmployees}`, field: 'max_employees', value: maxEmployees });
                if (hasWebsite) filters.push({ label: `Website: ${hasWebsite === '1' ? 'Has Website' : 'No Website'}`, field: 'has_website', value: hasWebsite });
        ...
        function toggleStatus(employerId, isChecked) {
            console.log('toggleStatus called:', employerId, isChecked);
            
            const statusValue = isChecked ? 1 : 0;
            const form = document.getElementById(`statusForm${employerId}`);
            const checkbox = document.getElementById(`status-toggle-${employerId}`);
