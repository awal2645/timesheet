    ...
    <div class="relative overflow-x-auto">
        <div class="m-6">
            <div
                ...
                <a href="{{ route('invoice.create') }}" class="bg-purple-500 text-white px-4 py-2 rounded-lg"><i
                        class="fa-solid fa-plus"></i> {{ __('Create Invoice') }}</a>
            </div>

            <div
                class="flex flex-wrap p-8 bg-white/10 dark:bg-black/10 rounded-lg border border-black/10 dark:border-white/10">
                <div class="w-full ">
                                                ...
                                                <tr class="hover:bg-gray-100 hover:dark:bg-gray-800">
                                                    ...
                                                    <td
                                                        ...
                                                        <a href="{{ route('invoice.edit', $invoice->id) }}"
                                                            class="text-purple-500 hover:underline">{{ __('Edit') }}</a>
