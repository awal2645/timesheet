    ...
    <div class="m-6">
        ...
        <div class="p-6 bg-white/10 dark:bg-black/10 rounded-lg border border-black/10 dark:border-white/10 shadow-md">
            ...
            <form method="POST" action="{{ route('invoice.update', $invoice->id) }}">
                ...
                <button type="submit"
                    class="text-white bg-purple-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">{{ __('Update') }}</button>
            </form>
        </div>
    </div>
</x-app-layout>
