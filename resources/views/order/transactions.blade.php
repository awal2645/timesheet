    ...
    <div class="relative overflow-x-auto">
        <div class="container mx-auto px-5">
            <div class=" mt-10 flex flex-col md:flex-row justify-between items-center md:space-y-0 ">
                ...
                <a href="{{ route('order.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg"><i
                            ...
                            <div class="overflow-x-auto pb-1">
                                <table class="min-w-full table-auto text-sm">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="border-b text-center border border-gray-300 dark:border-gray-700 mt-5 pt-5">
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="7" class="text-center py-8 border border-gray-300 dark:border-gray-700">
