                ...
                <form action="{{ route('reports.index') }}" method="GET" class="mb-6">
                    <div class="mb-5">
                        ...
                        <div class="flex flex-col md:flex-row items-center gap-4">
                            ...
                            <select name="status"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white pr-8">
                            ...
                            <button type="submit"
                                class="bg-primary-500 text-white px-4 py-2 rounded-lg hover:bg-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-400 focus:ring-opacity-50 transition duration-150 ease-in-out">{{ __('Search') }}</button>
                        </div>
                    </div>
                </form>
                                                    ...
                                                    <td class="px-6 py-4 space-x-2">
                                                        <span class="flex">
                                                            <a href="#"
                                                                ...
                                                                class="font-medium text-primary-600 dark:text-primary-500 hover:underline mr-2">
                                                        ...
                                                        <form id="feedbackForm{{ $timeReport->id }}"
                                                            ...
                                                            @if (auth('web')->user()->role != 'employee')
                                                                ...
                                                                <textarea id="feedback" name="feedback" required
                                                                    class="w-full h-30 px-3 py-5 text-gray-700 border border-gray-300 rounded-md focus:outline-none focus:border-primary-500">{{ $timeReport->feedback ?? '' }}</textarea>

                                                                <!-- Submit Button -->
                                                                <div class="text-center py-4">
                                                                    <button id="submitFeedbackButton"
                                                                        class="bg-primary-500 hover:bg-primary-700 text-white font-bold py-2 px-4 rounded">Submit</button>
                                                                </div>
                                                            @else
