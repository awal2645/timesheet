                                ...
                                <div
                                    ...
                                    <table class="w-full table-auto">
                                        ...
                                        <tbody>
                                            ...
                                            <tr
                                                ...
                                                <td class="border-b border-[#eee] dark:border-slate-700 px-4 py-3">
                                                    <div class="flex items-center space-x-2">
                                                        <span class="px-2 py-1 text-text-light dark:text-text-dark flex items-center justify-center text-sm w-[100px] truncate <?php echo e(
                                                ...
                                                <div @click.outside="openModal = null"
                                                    ...
                                                    <div class="grid grid-cols-3 items-start gap-8">
                                                        ...
                                                        <div class="col-span-2">
                                                            <div class="bg-card -light dark:bg-card-dark border-b">
                                                                <div
                                                                ...
                                                                <div class="timesheet-list">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="px-4 py-2">{{ $timesheet->day }}
                                                                        </div>
                                                                        <div class="px-4 py-2">{{ $timesheet->date }}
                                                                        </div>
                                                                        <div class="px-4 py-2">{{ $timesheet->hours }}
                                                                        </div>
                                                                    </div>
                                                                    @endforeach
                                                                </div>
                                            ...
                                            <div x-show="openMessageModal === 'message-modal-{{ $timeReport->id }}'"
                                                :class="{ 'z-60000': openMessageModal === 'message-modal-{{ $timeReport->id }}' }"
                                                ...
                                                <div
                                                    ...
                                                    <div class="absolute top-2 right-2">
                                                        <button @click="openMessageModal = null"
                                                            class="close-btn bg-primary-50 text-text-light dark:text-text-dark cursor-pointer">
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                                viewBox="0 0 24 24" stroke-width="1.5"
                                                                stroke="currentColor" class="w-6 h-6">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
