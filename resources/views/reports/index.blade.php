                    ...
                    <div class="mb-5">
                        ...
                        <div class="flex flex-col md:flex-row items-center gap-4">
                            ...
                            <select name="status"
                                ...
                                <option value="approve" {{ request('status')=='approve' ? 'selected' : '' }}>Approved
                                </option>
                                <option value="decline" {{ request('status')=='decline' ? 'selected' : '' }}>Declined
                                </option>
                                <!-- Add more status options as needed -->
                            </select>

                            <button type="submit"
                                class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-50 transition duration-150 ease-in-out">Search</button>
                        </div>
                    </div>
                </form>
                                    ...
                                    <tbody>
                                        ...
                                        <tr
                                            ...
                                            <td class="px-6 py-4 border border-gray-300 dark:border-gray-700">
                                                <div class="flex items-center space-x-2">
                                                    ...
                                                    <form id="statusForm{{ $timeReport->id }}"
                                                        ...
                                                        method="post">
                                                        @csrf
                                                        <div {{ $timeReport->status ===
                                                            'approve' ? '' : 'hidden' }}>Approved</div>
                                                        <div {{ $timeReport->status ===
                                                            'decline' ? '' : 'hidden' }}>Declined</div>
                                                        <div {{ $timeReport->status ===
                                            ...
                                            <td class="px-6 py-4 space-x-2">
                                                <span class="flex">
                                                    <a href="#" id="openTimesheetModal{{ $timeReport->id }}"
                                        ...
                                        <div id="feedbackModal{{ $timeReport->id }}"
                                            ...
                                            style="z-index: 100; ">
                                            <div class="relative bg-white shadow-lg max-w-md w-full p-8 rounded-lg">
                                                <!-- Modal Content -->
                                                <form id="feedbackForm{{ $timeReport->id }}"
                                                    ...
                                                    <div class="py-3 text-center">
                                                        <p class="mb-2">{{ $timeReport->feedback ?? 'No have feedback'
                                                            }}</p>
                                                    </div>
                                                    @endif
                                                </form>
                                            ...
                                            <div
                                                ...
                                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                    ...
                                                    <div class="flex justify-center mb-4">
                                                        <img id="modalImage" src="{{ asset($timeReport->image) }}"
                                                            alt="Modal Image"
                                                            ...
                                                            <div class="flex flex-col gap-4 mt-4">
                                                                <div class="flex justify-between">
                                                                    ...
                                                                    <button type="submit" disabled name="status"
                                                                        value="approve" class="bg-gray-500 text-white px-6 py-2
                                                                    ...
                                                                    <button type="submit"  name="status"
                                                                        value="approve" class="bg-green-500 text-white px-6 py-2
                                                                    ...
                                                                    <button type="submit" disabled  name="status"
                                                                        value="decline" class="bg-gray-500 text-white px-6 py-2
                                                                    rounded-md shadow hover:bg-gray-600
                                                                    focus:outline-none transition duration-150">
                                                                        Declined
                                                                    </button>
