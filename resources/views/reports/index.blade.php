                                            ...
                                            @if ($timeReports->count() > 0)
                                                ...
                                                <td
                                                    ...
                                                    <div class="text-sm font-semibold">
                                                                <div class="text-base font-semibold">{{ $timeReport->user?->username }}</div>
                                                                <div class="font-normal text-gray-500">{{ $timeReport->user?->email }}</div>
                                                            </div>
                                                        </th>
                                                        <td
                                                        class="border-b border-[#eee] dark:border-slate-700 px-4 py-3">
                                                            ...
                                                            <form id="feedbackForm{{ $timeReport->id }}"
                                                                ...
                                                                @else
                                                                    <div class="py-3 text-center">
                                                                        <p class="mb-2">{{ $timeReport->feedback ?? 'No feedback available' }}</p>
                                                                    </div>
                                                                @endif
                                                            </form>
                                                        </div>
                                                    ...
                                                    <div id="timesheetModal{{ $timeReport->id }}"
                                                        ...
                                                        <div class="modal-content bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl w-full max-w-6xl h-34 overflow-auto relative flex flex-col gap-6">
                                                            <div class="absolute top-4 right-4">
                                                                <button class="close-btn text-gray-600 dark:text-gray-400 cursor-pointer"
                                                                        ...
                                                                        <div class="timesheet-list">
                                                                            @foreach($timeReport->timesheets as $timesheet)
                                                                                <div class="grid grid-cols-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600">
                                                                                    <div class="px-4 py-2 text-center">{{ $timesheet->day }}</div>
                                                                                    <div class="px-4 py-2 text-center">{{ $timesheet->date }}</div>
                                                                                    <div class="px-4 py-2 text-center">{{ $timesheet->hours }}</div>
                                                                                </div>
                                                                            @endforeach
                                                                        </div>
                                                                    </div>
