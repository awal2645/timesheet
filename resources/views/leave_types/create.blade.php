...
<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="bg-white dark:bg-slate-800 shadow-2xl rounded-3xl overflow-hidden border border-gray-200 dark:border-gray-700">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                            {{ __('Define a new leave type for your organization. Specify the type name and provide a clear description for employees.') }}
                        </p>
                    </div>
                    
                    <!-- Quick Info -->
                    <div class="hidden md:flex items-center space-x-2">
                        <div class="text-sm text-gray-500 dark:text-gray-400">{{ __('New Type') }}</div>
            ...
            <!-- Form Content -->
            <div class="p-8">
                <form method="POST" action="{{ route('leave_types.store') }}" class="space-y-8" id="leaveTypeForm">
                    @csrf
                    ...
                    <div class="space-y-6">
                        <div class="border-b border-gray-200 dark:border-gray-600 pb-4">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">{{ __('Define the basic information for this leave type') }}</p>
                        </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative group">
                                    <textarea name="description" id="description" rows="4"
                                              class="w-full px-4 py-4 border-2 border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-slate-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all duration-200 hover:border-gray-400 dark:hover:border-gray-500 group-hover:shadow-md resize-none"
                                              placeholder="Provide a detailed description of this leave type, including any specific conditions, eligibility criteria, or usage guidelines...">{{ old('description') }}</textarea>
                                </div>
                                @error('description')
                                <div class="flex items-center mt-2 p-3 text-red-700 bg-red-50 dark:bg-red-900/20 dark:text-red-400 rounded-lg border border-red-200 dark:border-red-800">
                                    <svg class="w-5 h-5 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="text-sm text-teal-700 dark:text-teal-400 space-y-2">
                                    <p class="flex items-start">
                                        ...
                                        {{ __('Use clear, descriptive names that employees will easily understand') }}
                                    </p>
                                    <p class="flex items-start">
                                        <svg class="w-4 h-4 mr-2 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                        </svg>
                                        {{ __('Include specific conditions, eligibility, and approval requirements in the description') }}
                                    </p>
                                    <p class="flex items-start">
                                        <svg class="w-4 h-4 mr-2 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                        </svg>
                                        {{ __('Consider legal requirements and company policies for each leave type') }}
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-between pt-8 border-t border-gray-200 dark:border-gray-600 space-y-4 sm:space-y-0">
                        ...
                        <button type="submit" id="submitBtn"
                            ...
                            <span class="submit-text">{{ __('Create Leave Type') }}</span>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        window.useTemplate = function(typeName, description) {
            ...
            // Add visual feedback
            typeInput.classList.add('ring-2', 'ring-teal-500/20');
            descriptionInput.classList.add('ring-2', 'ring-teal-500/20');
            
            setTimeout(() => {
                typeInput.classList.remove('ring-2', 'ring-teal-500/20');
                descriptionInput.classList.remove('ring-2', 'ring-teal-500/20');
            }, 1000);
