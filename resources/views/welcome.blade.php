...
<body class="bg-neutral-900">
    ...
    <header class="sticky top-4 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full">
        <nav class="relative max-w-[66rem] w-full bg-white/10 backdrop-blur rounded-lg py-3 ps-5 pe-2 md:flex md:items-center md:justify-between md:py-0 mx-2 lg:mx-auto"
            aria-label="Global">
            <div class="flex items-center justify-between">
                <!-- Logo -->
                <a class="flex-none rounded-md text-xl text-white inline-block font-semibold focus:outline-none focus:opacity-80"
            ...
            <div id="navbar-collapse"
                ...
                <div
                    ...
                    <div>
                        <a class="group inline-flex items-center gap-x-2 py-2 bg-teal-500 font-medium text-sm text-white rounded-md focus:outline-none px-5"
                            href="{{ route('login') }}">
                            Login
                        </a>
                    </div>
    ...
    <main id="content">
        ...
        <div class="bg-neutral-900">
            <div class="max-w-5xl mx-auto">
                <div class="max-w-2xl px-4 xl:px-0 pt-24 lg:pt-32 pb-24">
                    <h1 class="font-semibold text-white text-5xl md:text-6xl">
                        <span class="text-teal-500">Timesheet App:</span> A Time Tracking Tool
                    </h1>
                    <div class="max-w-4xl">
                        <p class="mt-5 text-neutral-400 text-lg">
                            ...
                            realities. At Timesheet Agency, we specialize in turning conceptual visions into concrete forms,
                        ...
                        <div class="mb-5">
                            ...
                            <div class="mt-5">
                                ...
                                <p class="mt-1 text-neutral-400">With the aim of optimizing customer interactions and
                                    boosting brand loyalty, the team at Timesheet leveraged Mailchimp's powerful tools
                                    and expertise to deliver exceptional results.</p>
                            </div>
                        </div>
                        <p class="mt-auto">
                            <span
                                class="font-medium text-sm text-teal-500 pb-1 border-b-2 border-neutral-700 group-hover:border-[#ff0] transition focus:outline-none group-focus:border-[#ff0]">
                                Case study
                            </span>
                        </p>
                    </a>
                    ...
                    <a class="group relative z-10 p-4 md:p-6 h-full flex flex-col bg-neutral-900 first:rounded-t-xl last:rounded-b-xl lg:first:rounded-l-xl lg:first:rounded-tr-none lg:last:rounded-r-xl lg:last:rounded-bl-none before:absolute before:inset-0 before:bg-gradient-to-b before:hover:from-transparent before:hover:via-transparent before:hover:to-[#ff0]/10 before:via-80% before:-z-[1] before:last:rounded-b-xl lg:before:first:rounded-s-xl lg:before:last:rounded-e-xl lg:before:last:rounded-bl-none before:opacity-0 before:hover:opacity-100"
                        ...
                        <div class="mb-5">
                            ...
                            <div class="mt-5">
                                ...
                                <p class="mt-1 text-neutral-400">In collaboration with Shopify, Timesheet embarked on a
                        ...
                        <div class="mb-5">
                            ...
                            <div class="mt-5">
                                ...
                                <p class="mt-1 text-neutral-400"> With the goal of accelerating project delivery and
                                    enhancing collaboration among development teams, Timesheet leveraged GitLab's
                                    comprehensive suite of tools and Timesheet's expertise in digital product
                                    development.</p>
                            </div>
                        </div>
                        <p class="mt-auto">
        ...
        <div class="bg-neutral-900">
            <div class="max-w-5xl px-4 xl:px-0 py-10 lg:py-20 mx-auto">
                <!-- Title -->
                <div class="max-w-3xl mb-10 lg:mb-14">
                    <h2 class="text-white font-semibold text-2xl md:text-4xl md:leading-tight">Timesheet reviews</h2>
                    ...
                    <div
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 items-center gap-y-20 gap-x-12">
                            ...
                            <div
                                ...
                                <svg class="flex-shrink-0 size-6 sm:size-8 text-teal-500 mx-auto"
            ...
            <div class="max-w-5xl px-4 xl:px-0 py-10 lg:pt-20  mx-auto">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 lg:items-center">
                    ...
                    <div>
                        <!-- Heading -->
                        <div class="mb-4">
                            <h3 class="text-xs font-medium uppercase text-teal-500">
                                Steps
                            </h3>
                        </div>
                        <!-- End Heading -->
                        ...
                        <div class="flex gap-x-5 ms-1">
                            ...
                            <div
                                ...
                                <div class="relative z-10 size-8 flex justify-center items-center">
                                    <span
                                        class="flex flex-shrink-0 justify-center items-center size-8 border border-neutral-800 text-teal-500 font-semibold text-xs uppercase rounded-full">
                                        1
                                    </span>
                                </div>
                            </div>
                        ...
                        <a class="group inline-flex items-center gap-x-2 py-2 px-3 bg-teal-500 font-medium text-sm text-neutral-800 rounded-full focus:outline-none"
                            href="#">
                    ...
                    <div class="space-y-14">
                        ...
                        <div class="flex gap-x-5">
                            ...
                            <div class="grow">
                                ...
                                <p class="mt-2">
                                    <a class="group inline-flex items-center gap-x-2 font-medium text-sm text-teal-500 decoration-2 hover:underline focus:outline-none focus:underline"
                                        href="#">
                                        Job openings
                                        <svg class="flex-shrink-0 size-4 transition group-hover:translate-x-0.5 group-hover:translate-x-0 group-focus:translate-x-0.5 group-focus:translate-x-0"
                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
