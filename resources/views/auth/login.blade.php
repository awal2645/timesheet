    ...
    @if (env('APP_MODE') === 'demo')
        ...
        <div class="mt-6 grid grid-cols-2 gap-4">
            <button onclick="submitLoginForm('superadmin')"
                class="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-purple-500 dark:hover:bg-purple-500 dark:focus:ring-blue-800">
