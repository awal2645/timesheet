...
<div class="relative inline-flex" x-data="{ open: false }">
    <button
        ...
        <svg class="w-4 h-4" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
            <path class="fill-current text-card-light dark:text-card-dark"
                d="M8 0C3.6 0 0 3.6 0 8s3.6 8 8 8 8-3.6 8-8-3.6-8-8-8zm0 12c-.6 0-1-.4-1-1s.4-1 1-1 1 .4 1 1-.4 1-1 1zm1-3H7V4h2v5z" />
        </svg>
    </button>
    <div class="origin-top-right z-10 absolute top-full min-w-44 bg-card-light dark:bg-card-dark   text-text-light  
        ...
        <ul>
            <li>
                <a class="font-medium text-sm text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400 flex items-center py-1 px-3"
                    ...
                    <svg class="w-3 h-3 fill-current text-indigo-300 dark:text-indigo-500 shrink-0 me-2"
                        viewBox="0 0 12 12">
