...
">
        ...
        <button id="paypal_btn" class="text-white paypal_btn text-2xl bg-blue-600 rounded-lg px-4 py-2">
        ...
        <button id="paypal_btn" class="text-white paypal_btn bg-blue-600 rounded-lg px-4 py-2">
            {{ __('Pay with PayPal') }}
        </button>
        @endif
        @endif
