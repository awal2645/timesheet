...
<div x-data="{ searchOpen: false }">
    ...
    <div id="search-modal"
        ...
        <div class="bg-white dark:bg-slate-800   text-text-light  
 dark:text-text-dark   border border-transparent dark:border-slate-700 overflow-auto max-w-2xl w-full max-h-full rounded shadow-lg"
            ...
            <form class="border-b border-slate-200 dark:border-slate-700">
                <div class="relative">
                    ...
                    <input id="modal-search"
                        class="w-full dark:text-slate-300 bg-white dark:bg-slate-800   text-text-light  
 dark:text-text-dark   border-0 focus:ring-transparent placeholder-slate-400 dark:placeholder-slate-500 appearance-none py-3 ps-10 pe-4"
                        type="search" placeholder="Search…" x-ref="searchInput" />
                    <button class="absolute inset-0 right-auto group" type="submit" aria-label="Search">
                        <svg class="w-4 h-4 shrink-0 fill-current text-slate-400 dark:text-slate-500 group-hover:text-slate-500 dark:group-hover:text-slate-400 ms-4 me-2"
                    ...
                    <ul class="text-sm">
                        <li>
                            <a class="flex items-center p-2 text-slate-800 dark:text-slate-100 hover:text-white hover:bg-indigo-500 rounded group"
                                ...
                                <svg class="w-4 h-4 fill-current text-slate-400 dark:text-slate-500 group-hover:text-white group-hover:text-opacity-50 shrink-0 me-3"
                                    viewBox="0 0 16 16">
                                    <path
