<div
 ...
 dark:text-text-dark   shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
    <header class="px-5 py-4 border-b border-slate-100 dark:border-slate-700 flex items-center">
        ...
        <div class="relative ms-2" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
            ...
            <div class="z-10 absolute bottom-full left-1/2 -translate-x-1/2">
                <div class="min-w-72 bg-white dark:bg-slate-700 dark:text-slate-100 border border-slate-200 dark:border-slate-600 p-3 rounded shadow-lg overflow-hidden mb-2"
    ...
    <div class="px-5 py-3">
        <div class="flex items-start">
            <div class="text-3xl font-bold text-slate-800 dark:text-slate-100 me-2">+$6,796</div>
