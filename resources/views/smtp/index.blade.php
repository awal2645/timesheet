...
<x-app-layout>
    <div class="m-6 p-6 bg-white/10 dark:bg-black/10 border border-black/10 dark:border-white/10 rounded-lg shadow-md">
        ...
        <form method="POST" action="{{ route('email.update') }}"
            ...
            <!-- SAVE BUTTON -->
            <button type="submit"
                class="w-full text-white bg-purple-500 hover:bg-purple-700 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none focus:ring-opacity-50">
                {{ __('Save') }}
            </button>
        </form>
    </div>
