    ...
    <div class="relative overflow-x-auto">
        <div class="m-6">
            ...
            <div class="my-8 card flex flex-col md:flex-row gap-4 md:justify-between items-start md:items-center">
                <form action="{{ route('zoom.meeting.index') }}" method="GET">
                    <div class="mb-3">
                        ...
                        <div class="flex form-field">
                            ...
                            <button
                                class="bg-primary-50 text-text-light dark:text-text-dark px-4 py-2 rounded-md ms-2">{{
                                __('Search') }}</button>
                        </div>
                    </div>
                </form>
                            ...
                            <table class="w-full table-auto">
                                <thead class="table-header">
                                    <tr class="rounded-none text-left">
                                        <th scope="col" class="min-w-[220px] px-4 py-4 font-medium">
                                            {{ __('Meeting Topic') }}
                                        </th>
                                        <th scope="col" class="min-w-[150px] px-4 py-4 font-medium">
                                            {{ __('Host Mail') }}
                                        </th>
                                        <th scope="col" class="min-w-[120px] px-4 py-4 font-medium">
                                            {{ __('Start Date') }}
                                        </th>
                                        <th scope="col" class="min-w-[120px] px-4 py-4 font-medium">
                                            {{ __('Password') }}
                                        ...
                                        <td class="px-6 py-4  ">
                                            ...
                                            <div class="">
                                                ...
                                                <div class="font-normal text-gray-500 mt-5">
                                                    <a target="__blank" 
                                                        class="text-text-light dark:text-text-dark bg-primary-50 hover:bg-primary-300 focus:outline-none focus:ring-4 focus:ring-primary-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mb-2 dark:bg-primary-50 dark:hover:bg-primary-50 dark:focus:ring-primary-900"
