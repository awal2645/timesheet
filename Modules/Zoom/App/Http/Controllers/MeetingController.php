...
namespace Modules\Zoom\App\Http\Controllers;

use App\Http\Controllers\Controller;
use App\Http\Requests\Meeting\MeetingCreateRequest;
use Modules\Zoom\App\Models\Meeting;
use App\Models\User;
use Modules\Zoom\App\Services\Meeting\CreateMeetingService;
use Modules\Zoom\App\Services\Meeting\UpdateMeetingService;
use Modules\Zoom\App\Traits\ZoomMeetingTrait;
use Exception;
...
class MeetingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('zoom::meetings.index', compact('meetings', 'users', 'roles'));
    }
    ...
    public function create()
    {
        ...
        return view('zoom::meetings.create', compact('meetings', 'users', 'roles'));
    }
    ...
    public function destroy(Meeting $meeting)
    {
        try {
            ...
            return back()
                ->withErrors(['error' => 'An error occurred while deleting the meeting.']);
        }
    }
} 